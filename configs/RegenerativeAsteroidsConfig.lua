RegenerativeAsteroidsConfig = {
    ...
    MinableAsteroidLimit = 100; -- number of asteroids to maintain in the sector.
    NeutralZone = true; -- true or false, true will enable Regenerative-Asteroids for all neutral zones.
